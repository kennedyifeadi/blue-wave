...
export const Sidebar = () => {
  ...
  return (
    <div className="w-max h-max md:relative absolute md:h-full right-[15px] top-[5px] md:pl-4">
      <div
        ref={sidebarRef}
        className={`flex md:relative absolute top-[-4px] md:top-[-2px] md:translate-x-0 flex-col bg-gray-50 md:w-64 w-72 md:h-full h-[100dvh] duration-500 ease-in-out gap-3 md:gap-0 md:rounded-lg rounded-tr-none rounded-br-none p-4 ${
