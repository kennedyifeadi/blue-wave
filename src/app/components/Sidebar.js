    ...
    return (
      <div className="flex flex-col bg-gray-50 w-60 h-full rounded-lg p-4">
        ...
        <ul className="flex flex-wrap gap-3 w-full justify-between ">
          {/* Predictive Weather */}
          <li className="flex flex-col text-[15px]  items-center justify-center w-[47%] h-[60px] border bg-[#dbdbdb33] rounded-md">
          ...
          {/* Device Connected */}
          <li className="flex flex-col text-[15px] justify-center items-center w-[47%] h-[60px] border bg-[#dbdbdb33] rounded-md">
        ...
        {/* Import Data Button */}
        <div className="mt-2">
          <button className="bg-blue-500 text-white text-[12px] w-full py-1 rounded hover:bg-blue-600">
            Import Data
          </button>
        </div>
      </div>
